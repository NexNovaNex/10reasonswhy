...
const Page: FC = () => {
  ...
  return (
    <main className="bg-[#f8fafc] min-h-screen pb-40">
      ...
      <div className="max-w-3xl mx-auto px-4 pt-1 pb-10"> {/* pt-1 for minimal top space */}
        ...
        <div className="mb-8">
          <div className="relative overflow-hidden rounded-2xl shadow-2xl">
            <Image
              src="/OG1-placeholder.jpg"
              alt="OneFix Labs Microneedling Kit - Advanced Hair Growth Solution"
              width={1200}
              height={600}
      ...
      {/* Sticky CTA Bar */}
      <div className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-slate-200 shadow-lg px-1 py-1 md:py-2 flex flex-col items-center md:items-stretch">
        <div className="max-w-md w-full mx-auto flex flex-col items-center">
          <a
            href={CTA_LINK}
            target="_blank"
            rel="noopener noreferrer"
            className="block w-full rounded-xl bg-[#2563eb] hover:bg-[#1e40af] text-white text-sm md:text-base font-semibold md:font-bold text-center py-2 md:py-2 transition mb-1 md:mb-1 shadow"
          >
            Order Now <span className="ml-2">&rarr;</span>
          </a>
          <div className="flex w-full justify-between items-center text-[10px] md:text-xs text-slate-500 px-0 md:px-1">
